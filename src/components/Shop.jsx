        ...
        <aside className="lg:w-56 shrink-0">
          ...
          <div className={`lg:block space-y-6 ${filterOpen ? "block" : "hidden"}`}>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 bg-black/5 dark:bg-white/5 border border-[#e8dfc8] dark:border-white/10 rounded-xl px-3 py-2.5 focus-within:border-orange-500 transition-colors">
            ...
            {(activeBrand !== "All" || activeCategory !== "All" || search || sortBy !== "default") && (
              <button onClick={resetFilters}
                className="w-full py-2.5 rounded-xl border border-[#e8dfc8] dark:border-white/10 text-[#6b5d3f] dark:text-slate-400 text-sm hover:border-orange-500 hover:text-orange-600 dark:hover:text-orange-400 transition-all">
                Reset Filters
              </button>
            )}
          </div>
        ...
        <div className="flex-1">
          {paginated.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-24 text-[#9a8a64] dark:text-slate-500">
              ...
              <button onClick={resetFilters} className="mt-4 text-sm text-orange-600 dark:text-orange-400 hover:underline">Clear filters</button>
            </div>
          ) : (
            <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-4">
              {paginated.map((p, i) => (
                <div key={p.id}
                  ...
                  className="group bg-white dark:bg-white/[.03] border border-[#e8dfc8] dark:border-white/10 rounded-2xl overflow-hidden cursor-pointer hover:border-orange-500/50 dark:hover:border-orange-600/40 hover:-translate-y-1 transition-all duration-300 shadow-sm dark:shadow-none product-card-anim"
