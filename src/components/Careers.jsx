...
import { Briefcase, Upload, Calendar, User, Mail, Phone, FileText, ChevronDown, CheckCircle, MapPin } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="reveal">
            ...
            <div className="bg-gradient-to-br from-yellow-100/60 dark:from-yellow-900/20 to-yellow-50/30 dark:to-yellow-800/5 border border-yellow-200 dark:border-yellow-600/20 rounded-2xl p-6">
              ...
              <p className="text-[#3f3522] dark:text-slate-300 text-sm mb-1"><MapPin size={15} className="inline-block mr-2" /> #12 Kabignayan St., Doña Josefa, Quezon City</p>
              <p className="text-[#3f3522] dark:text-slate-300 text-sm mb-1"><Phone size={15} className="inline-block mr-2" /> (02) 8-7118005</p>
              <p className="text-[#3f3522] dark:text-slate-300 text-sm"><Mail size={15} className="inline-block mr-2" /> careers@gtotrading.com.ph</p>
            </div>
          </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <select name="position" value={form.position} onChange={handleChange} required
                        className="w-full bg-[#faf6ea] dark:bg-white/5 border border-[#e8dfc8] dark:border-white/10 rounded-xl pl-10 pr-10 py-3 text-sm outline-none focus:border-yellow-500 transition-colors appearance-none cursor-pointer text-[#1c1505] dark:text-slate-100">
                    ...
                    <button type="submit"
                      className="w-full py-3.5 rounded-xl bg-gradient-to-r from-yellow-700 to-yellow-400 text-white font-bold text-sm hover:-translate-y-0.5 transition-transform border-none cursor-pointer"
